...
/**
 * Public viewer for the official TalentSocio Talent Partner Network Agreement.
 */
  ...
  return (
    <main className="mx-auto max-w-4xl px-6 py-12 text-[#0F172A]">
      ...
      <p className="mt-3 text-sm text-[#64748B]">
        Official TalentSocio Talent Partner Network Agreement (PDF). During
        registration you must read through to the last page, then tick “I have
        read terms and conditions till last page. I agree.”
      </p>

      <div className="mt-8 overflow-hidden rounded-xl border border-[#E2E8F0] bg-[#E2E8F0]">
        <iframe
          title="TalentSocio Talent Partner Network Agreement"
      ...
      <div className="mt-8 flex flex-wrap gap-4">
        ...
        <a
          ...
          download="TalentSocio-Talent-Partner-Network-Agreement.pdf"
