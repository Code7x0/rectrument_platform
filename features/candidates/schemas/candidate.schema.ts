...
export const candidateFormSchema = z.object({
  ...
  offerInHandCtc: z.string().trim().optional().or(z.literal("")),
  offerInHandLocation: z.string().trim().optional().or(z.literal("")),
  offerInHandDoj: z.string().trim().optional().or(z.literal("")),
  offerInHandCompany: z.string().trim().optional().or(z.literal("")),
  offerInHandReason: z.string().trim().optional().or(z.literal("")),
